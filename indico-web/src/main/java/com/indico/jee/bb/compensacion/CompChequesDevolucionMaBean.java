...
public class CompChequesDevolucionMaBean extends GraficaGeneralBean {
	...
	private final String HEADER = 	"	<Header>	\r\n" +
									"			<ID>Indico - Distribución Tipo Plaza Devoluciones</ID>	\r\n" +
									"			<Test>false</Test>													\r\n" +
									"			<Truncated>false</Truncated>										\r\n" +
									"			<Name xml:lang=\"es\">Indico -  Distribución Tipo Plaza Devoluciones</Name>	\r\n" +
									...
									"	</Header>	\r\n" +
									"	<DataSet>	\r\n" +
									"		<generic:KeyFamilyRef>INDICO_Distribución_Tipo_Plaza_Devoluciones</generic:KeyFamilyRef>	\r\n" +
    ...
    private void createXMLFile (List<AnalisisChequesCompensa> valores) {
    	...
    	try {
    		wb = new HSSFWorkbook();
    		Sheet sheet = wb.createSheet("indico_devoluciones");
            ...
            response.setHeader(CONTENT_DISPOSITION_LITERAL, "attachment; filename=indico_devoluciones.xls");
    ...
    private void createCSVFile(List<AnalisisChequesCompensa> valores) {
        ...
        try {
            ...
            response.setHeader(CONTENT_DISPOSITION_LITERAL, "attachment; filename=indico_devoluciones.csv");
			output = response.getOutputStream();
    ...
    private void createSDMXFile(List<AnalisisChequesCompensa> valores) {
        ...
        try {
                ...
                response.setHeader(CONTENT_DISPOSITION_LITERAL, "attachment; filename=Distribucion_tipo_plaza_devoluciones_dmx.xml");
    			output = response.getOutputStream();

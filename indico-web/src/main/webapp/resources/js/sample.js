 ...
 **/
 ...
 /**
  * Funcion que crea un array con las horas del dÃ­a
 ...
 function addaniotimes(data,selanio,selected) {
     ...
     if ($(selanio).length) {
         ...
         var option = $('<option/>').val("").text("AÃ±o").attr('disabled','disabled');
 ...
 function adddiastimes(data,seldia,selected) {
     if ($(seldia).length) {
         ...
         var option = $('<option/>').val("").text("DÃ­a").attr('disabled','disabled');
 ...
 function changedatesselectedstimes(compdiario1,compdiario2,data,slider) {
     ...
     //Primer y ultimo valor de dÃ­as
     ...
     //Primer y ultimo valor de dÃ­a 2
 ...
 //Update de la grÃ¡fica transacciÃ³n por concepto
 ...
 // Update para las grÃ¡ficas RotaciÃ³n y PIB
 ...
 function addanio(data,selanio,selected) {
     if ($(selanio).length) {
         var selectanio = $(selanio);
         selectanio.empty();
         var option = $('<option/>').val("").text("AÃ±o");
         option.appendTo(selectanio);
 ...
 function createSliderMinDiario(divchartzoomslider,compdiario1,compdiario2,concepto,label,errormessage){
     ...
     try {
         ...
         startvaluescomponentstimes (null,null,compdiario1,compdiario2,data);
 ...
 function createSliderMinMensual(divchartzoomslider,compmensual1,compmensual2,concepto,label,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
         ...
         if (label==null || label =="undefined") label = "Todos";
         data["Title"] = data["Title"] + " - " + label; 
         startvaluescomponentstimes (null,null,compmensual1,compmensual2,data);
         var divchartmax = document.createElement('div');
         divchartmax.id=divchartzoomslider+"_chartMax";
         divchartmax.style="chartcustom"
         document.getElementById(divchartzoomslider).appendChild(divchartmax);
 ...
 function createSliderMinTrimestral(divchartzoomslider,comptrimestral1,comptrimestral2,concepto,label,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
         ...
         if (label==null || label =="undefined") label = "Todos";
         data["Title"] = data["Title"] + " - " + label; 
         startvaluescomponentstimes (null,null,comptrimestral1,comptrimestral2,data);
         var divchartmax = document.createElement('div');
         divchartmax.id=divchartzoomslider+"_chartMax";
         divchartmax.style="chartcustom"
         document.getElementById(divchartzoomslider).appendChild(divchartmax);
 ...
 function createSliderMinSemestral(divchartzoomslider,compsemestral1,compsemestral2,concepto,label,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
         ...
         if (label==null || label =="undefined") label = "Todos";
         data["Title"] = data["Title"] + " - " + label; 
         startvaluescomponentstimes (null,null,compsemestral1,compsemestral2,data);
         var divchartmax = document.createElement('div');
         divchartmax.id=divchartzoomslider+"_chartMax";
         divchartmax.style="chartcustom"
         document.getElementById(divchartzoomslider).appendChild(divchartmax);
 ...
 function createSliderMinAnual(divchartzoomslider,companual1,companual2,concepto,label,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
         ...
         if (label==null || label =="undefined") label = "Todos";
         data["Title"] = data["Title"] + " - " + label; 
         startvaluescomponentstimes (null,null,companual1,companual2,data);
         var divchartmax = document.createElement('div');
         divchartmax.id=divchartzoomslider+"_chartMax";
         divchartmax.style="chartcustom"
         document.getElementById(divchartzoomslider).appendChild(divchartmax);
     ...
     var plot2 = $.jqplot(name, [serieValores,serieCantidad] , {
         ...
         axes:{
             ...
             y2axis:{
                 ...
                 max:maxCantidad,
                 showLabel:true,
                 label: '<div style="padding-left: 28px;"><div style="padding-left: 18px;">NÃºmero</div><div>Transacciones</div></div>',
                 textColor: "#006fb9",
                 rendererOptions:{ 
                   tickRenderer:$.jqplot.CanvasAxisTickRenderer,
                   forceTickAt0: true,
 ...
 function createSliderRotaMinTrimestral(divchartzoomslider,comptrimestral1,comptrimestral2,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
 ...
 function createSliderRotaMinSemestral(divchartzoomslider,compsemestral1,compsemestral2,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
 ...
 var datarotaanual;
 function createSliderRotaMinAnual(divchartzoomslider,companual1,companual2,errormessage){
 ...
 var datapibdiario;
 function createSliderRotaMinDiarioPib (divchartzoomslider,compdiario1,compdiario2,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
 ...
 var datapibmensual;
 function createSliderRotaMinMensualPib (divchartzoomslider,compmensual1,compmensual2,errormessage){
 ...
 function createSliderRotaMinTrimestralPib (divchartzoomslider,comptrimestral1,comptrimestral2,errormessage){
     var targetPlot,controllerPlot,idMini,idDivSlider,data;
     try {
         if (!($("#"+divchartzoomslider).length)) return;
 ...
 function createSliderRotaMinSemestralPib (divchartzoomslider,compsemestral1,compsemestral2,errormessage){
 ...
 var datapibanual;
 function createSliderRotaMinAnualPib (divchartzoomslider,companual1,companual2,errormessage){
